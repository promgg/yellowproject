...
Config.Photographers = {
    ["Valentine"] = {
        promptCoords = vector4(-170.7112, 623.6540, 114.0321, 228.4342),
        promptDistance = 2,
        pedCoords = vector4(-170.7112, 623.6540, 114.0321, 228.4342),
        camCoords = vector4(-169.81, 622.86, 114.63, 48.43), -- คำนวณอัตโนมัติ (หน้า ped ~1.2m) ปรับได้
        camFov = 60.0,
    },
    ["Rhodes"] = {
        promptCoords = vector4(1221.5322, -1302.0590, 76.8985, 135.7318),
        promptDistance = 2,
        pedCoords = vector4(1221.5322, -1302.0590, 76.8985, 135.7318),
        camCoords = vector4(1220.69, -1302.92, 77.50, 315.73), -- คำนวณอัตโนมัติ (หน้า ped ~1.2m) ปรับได้
        camFov = 60.0,
    },
    ["Annesburg"] = {
        promptCoords = vector4(2926.5059, 1285.3009, 44.6548, 68.1800),
        promptDistance = 2,
        pedCoords = vector4(2926.5059, 1285.3009, 44.6548, 68.1800),
        camCoords = vector4(2925.39, 1285.75, 45.25, 248.18), -- คำนวณอัตโนมัติ (หน้า ped ~1.2m) ปรับได้
        camFov = 60.0,
    },

    -- ["Blackwater"] = {  -- คอมเมนต์ไว้ เหลือแค่ 3 เมือง
...
Config.IDCardNPC = {
    --[[ คอมเมนต์ไว้ เหลือแค่ 3 เมือง (Valentine / Rhodes / Annesburg)
    ["Blackwater"] = {
    ...
    ["Rhodes"] = {
        coords = vector4(1226.923828125, -1294.9278564453125, 76.90569305419922, 36.3926),
        models = "cs_brontesbutler",
        distance = 3,
        blips = {
            name = "IDENTITY PROCESS",
