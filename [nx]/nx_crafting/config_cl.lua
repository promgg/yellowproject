...
-- แถบคราฟ (lp_progbar)
-- ห้ามต่ำกว่า ~3 วินาที: server ตั้ง readyAt = now + 3 ถ้าเสร็จเร็วกว่านั้นจะโดนปฏิเสธ
-- ว่า "คราฟยังไม่เสร็จ" และห้ามเกิน 20 วินาที (expiresAt) ไม่งั้นเซสชันหมดอายุ
...
Config["Craft_Table"] = {
	...
	{
		Position = {x = 2419.6143, y = 851.8325, z = 72.2546, h = -75.0001},
