...
Horses = { -- Gold to Dollar Ratio Based on 1899 Gold Price / sellPrice is 60% of cashPrice / Cash Price is Regular Game Price
	...
	-- 	breed = 'Main',
	-- 	colors = {
	-- 		['a_c_horsemule_01']                = { color = 'Mule',    cashPrice = 50, goldPrice = 1, invLimit = 30, job = {} },
	-- 		['a_c_horse_kentuckysaddle_chestnutpinto']         = { color = 'Chestnut Pinto',      cashPrice = 3500,  goldPrice = 2,  invLimit = 60, job = {} },
	-- 		['a_c_horse_morgan_bay']              = { color = 'Bay',             cashPrice = 4500, goldPrice = 2, invLimit = 60, job = {} },
	-- 	}
	-- }
}
