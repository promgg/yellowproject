...
-- ══════════════════════════════════════════════════════════════════════════════
-- สีอุปกรณ์ม้า (tack tint) — พรีเซ็ตสีที่โชว์ในเมนูแต่งม้า
-- t0/t1/t2 = index ในจานสีของวัสดุ (0-254) ไม่ใช่ RGB! (255 = ปิด channel = สีดั้งเดิม)
-- ทาให้ทุกชิ้นอุปกรณ์พร้อมกัน (อาน/ผ้าคลุม/กระเป๋า ฯลฯ) — เว้นตัวม้า/ขน (palette metaped_tint_horse)
-- ⚠️ สีจริงขึ้นกับจานสีของแต่ละวัสดุ ค่า index เดียวกันคนละวัสดุอาจได้คนละเฉด
--    → ลองในเกนด้วย /tacktint <t0> <t1> <t2> แล้วปรับ t0/t1/t2 + label + hex ให้ตรงสีจริง
--    (hex เป็นแค่สีตัวอย่างบนปุ่ม UI ไม่ต้องเป๊ะกับในเกม)
Config.TackTintEnabled = true      -- เปิด/ปิดฟีเจอร์เปลี่ยนสีอุปกรณ์ในเมนูแต่งม้า
Config.TackTints = {
    { label = 'สีเดิม',     hex = '#9a7a52', t0 = 255, t1 = 255, t2 = 255 }, -- ปิด tint = สีดั้งเดิมของอุปกรณ์
    { label = 'ดำ',        hex = '#1e1a17', t0 = 0,   t1 = 0,   t2 = 0   },
    { label = 'น้ำตาลเข้ม', hex = '#3d2817', t0 = 24,  t1 = 24,  t2 = 24  },
    { label = 'น้ำตาล',    hex = '#6b4a2b', t0 = 56,  t1 = 56,  t2 = 56  },
    { label = 'แทน',       hex = '#a5804f', t0 = 88,  t1 = 88,  t2 = 88  },
    { label = 'ทราย',      hex = '#c9a56f', t0 = 120, t1 = 120, t2 = 120 },
    { label = 'เทา',       hex = '#75726c', t0 = 152, t1 = 152, t2 = 152 },
    { label = 'แดงอิฐ',     hex = '#7a2f26', t0 = 184, t1 = 184, t2 = 184 },
    { label = 'เขียวเข้ม',  hex = '#324a2c', t0 = 208, t1 = 208, t2 = 208 },
    { label = 'ครีม',      hex = '#d8cbb0', t0 = 232, t1 = 232, t2 = 232 },
}
