script_name = script_name or 'lp_airdropteam'
...
-- Retired: pickup now uses lp_textui:TextUIHold (grip) + lp_progbar (opening), แบบ nx_event.
-- Kept as `false` so the old nuiLootProgress() call sites throughout this file become no-ops.
local USE_LOOT_PROGRESS_UI = false
