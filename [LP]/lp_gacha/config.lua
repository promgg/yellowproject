...
-- หน่วงการ "แจกของจริง" ไว้จนอนิเมชันเผยผลเสร็จ กันผู้เล่นเห็นของเข้ากระเป๋าก่อนหลอดโหลดจบ
-- ต้อง >= เวลาอนิเมชันฝั่ง NUI (MIN_OPEN_MS 1800 + reveal 380 ≈ 2180ms) ให้ของเข้าหลังเผยผล
Config.RevealMs      = 2300
