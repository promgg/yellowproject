...
Config.Locale = {
    ["en"] = {
        ["change_dimension"] = "You have switched to dimension ${bucketId}!",
        ["default_dimension"] = "You have switched to the default dimension!",
    }    
}


Config.dimensionNotify = true
Config.dimensionZones = { 
    [1] = {
        dimensionId = 1,
        ---- ZONE -----
