...
Config["Job"] = 'doctor'  -- หน่วยงานอะไร
...
Config["translate"] = {
	...
	text = "<span style=\"font-size:14px;color:white;\"><b>%s</b></span> <span style=\"color:white;\"><br><dd>📌</span> <span style=\"color:orange;\"><b>%s</b></span>",
	tip = "<span style=\"font-size:12px;color:white;\"><b> เพื่อรับงานนี้</b></span>",
	action_dead = "<dd><span style=\"font-size:17px;color:yellow;\">📢 มีผู้บาดเจ็บอยู่ที่</span>",
}
