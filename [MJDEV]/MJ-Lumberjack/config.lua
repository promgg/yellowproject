...
-- ระยะที่ marker ขึ้นเหนือต้นไม้ (ต้องกว้างกว่า ChopRange เพื่อให้ผู้เล่นเห็นก่อนถึง)
-- เดิม hardcode 5.0 ในโค้ด marker เลยโผล่ตอนยืนเกือบชิดต้นแล้ว ผู้เล่นสังเกตไม่ทัน
-- ค่านี้ยังเป็นรัศมีค้นหาต้นไม้ด้วย ยิ่งกว้างยิ่งกินแรงตอนวน itemset — 25 คือจุดที่พอดี
Config.TreeScanRange = 25.0
