...
Config = {}
-- ตั้งค่าจริงผ่าน convar ใน server.cfg: set mj_animal_discord_webhook "https://discord.com/api/webhooks/..."
Config['DiscordWebhook'] = GetConvar("mj_animal_discord_webhook", "")
